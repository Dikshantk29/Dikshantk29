...
I am a motivated **Information Technology Graduate** with a strong passion for building scalable, high-performance web applications. I specialize in the **Java Ecosystem**, focusing on backend logic, database management, and connecting it to modern front-end interfaces.

Currently, I am deep-diving into **Data Structures & Algorithms (DSA)** to enhance my problem-solving skills while building industry-standard projects.
...
| :--- | :--- |
| **Languages** | ![Java](https://img.shields.io/badge/java-%23ED8B00.svg?style=flat&logo=openjdk&logoColor=white) ![JavaScript](https://img.shields.io/badge/javascript-%23323330.svg?style=flat&logo=javascript&logoColor=%23F7DF1E) ![SQL](https://img.shields.io/badge/sql-%23000.svg?style=flat&logo=mysql&logoColor=white) |
...
### 🔭 Current Focus
- ☕ Mastering **Core Java & Multithreading**.
- 🌱 Building RESTful APIs using **Spring Boot**.
- 🧩 Solving **DSA problems** daily (Arrays, Strings, Recursion) to improve logic.
